...
- 001-refactor-attendance-module: Added Dart 3.6+ / Flutter (latest stable) + `cloud_firestore ^6.0.1`, `firebase_auth ^6.0.2`, `local_auth ^2.3.0`, `table_calendar ^3.1.2`, `percent_indicator ^4.2.3`, `intl ^0.20.0`
